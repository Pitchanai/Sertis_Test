...
class PartyCard extends Component<PartyCardProps> {
  constructor(props: PartyCardProps) {
    super(props)
    ...
    return (
      ...
      >
        ...
        <div className="card-action-container">
          <div>{this.props.value.joinedMember}/{this.props.value.maxMember}</div>
          <div>
            <Button 
  ...
  partyAction = async (event: any) => {
    if (this.props.value.isOwner) { return }
